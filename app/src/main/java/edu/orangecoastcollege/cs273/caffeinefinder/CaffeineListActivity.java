...
public class CaffeineListActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hookup our support map fragment to this activity
        SupportMapFragment caffineMapFragment = (SupportMapFragment)
                getSupportFragmentManager().findFragmentById(R.id.caffineMapFragment);

        caffineMapFragment.getMapAsync(this);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Change camera view to current position:
        LatLng currentPosition = new LatLng(33.671028,-117.911305);
        CameraPosition cameraPosition = new
                CameraPosition.Builder().target(currentPosition).zoom(14.0f).build();
